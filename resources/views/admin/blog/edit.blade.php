                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea name="content" id="summernote" cols="30" rows="10">{{$blog->content}}</textarea>
                                        @error('content')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Nhập tiêu đề" autocomplete="off" value="{{$blog->name}}">
                                        @error('name')
                                            <small class="text-danger">{{$message}}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div >
                                            <img src="{{url('public/upload')}}/{{$blog->image}}" width="100%" id="img" class="mt-3">
                                        </div>
                                        @error('image')
                                            <small class="text-danger">{{$message}}</small>
                                        @enderror
