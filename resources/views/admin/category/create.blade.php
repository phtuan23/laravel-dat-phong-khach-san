...
<section class="content pb-5">
    <div class="container-fluid">
        <form method="post" action="{{route('category.store')}}" enctype="multipart/form-data" id="formData">
            @csrf
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="size" class="form-control" placeholder="Nhập diện tích phòng" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Số người tối đa <span class="text-danger">*</span></label>
                                        <input type="text" name="max_people" class="form-control" placeholder="Nhập số người tối đa" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
