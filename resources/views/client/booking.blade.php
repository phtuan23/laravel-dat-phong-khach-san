...
<div class="container mb-5 mt-4" id="main">
...
<script>
    $(document).ready(function(){
        ...
        function show_hide_service(){
            $(".form_service").hide();
            $(document).on('click','.btn-service',function(){
                if($(".form_service").is(':hidden')){
                    var id = $(this).attr('id');
                    $("#form-"+id).toggle('slow');
                    $(".btn-service").text("X");
                }else{
        ...
        function add_service(){
            $(document).on('click','.services',function(){
                var id = $(this).attr('id');
                var form_service = $("#form-"+id).serialize();
                $.ajax({
